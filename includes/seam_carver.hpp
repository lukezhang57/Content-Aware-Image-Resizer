...
public:
   ...
   */
  int SquareNum(int num) const;
  int EnergyFormula(Pixel left, Pixel right, Pixel top, Pixel bottom) const;
  int** AccumulateVertical() const;
  int** AccumulateHorizontal() const;
private:
  ImagePPM image_;
  int height_;
  int width_;
